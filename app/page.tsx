...
import { Plus, FolderOpen, Link, Copy, ExternalLink, Trash2 } from 'lucide-react'
                      ...
                      <div key={page.id} className="flex items-center justify-between px-6 py-4 hover:bg-gray-50">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <a href={`/edit/${page.id}`} className="text-gray-300 hover:text-blue-500 p-1.5" title="Modifier">
                              <Link size={16} />
                            </a>
